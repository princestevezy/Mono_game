...
messagebox.showinfo("About Mono Game","Welcome To Mono.A Game which allows you to Play A Game Predictions With The System Using Only Numbers.Levels In This Game consist of Easy,For Easy you Will Have To Guess Between 11 to 16.Hard(For Hard You Will Have To Guess Between 11 to 25.Very Hard,For Hard You Will Have To Guess Between 11 to 30")
#frame
